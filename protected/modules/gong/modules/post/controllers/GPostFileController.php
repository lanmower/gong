...
class GPostFileController extends GFileController {
    public function accessRules() {
        return array(
            array('allow',
                'actions' => array('delete', 'upload', 'inlineUpdate', 'process'),
                'expression' => array('GPostController', 'allowOnlyProducer'),
            ),
            array('allow',
                'actions' => array('download', 'downloadOgg', 'downloadM4v','downloadM4a', 'downloadMp3', 'downloadImage', 'details', 'delete', 'upload', 'inlineUpdate'),
   ...
   public function loadModel($id) {
    ...
    public function actionUpload() {
        ...
        foreach($this->uploads as $upload) {
            ...
            $this->json['html'] .= $this->render('upload', array('postFile' => $postFile, 'oldCoverId'=>$oldCoverId), true);
       }
