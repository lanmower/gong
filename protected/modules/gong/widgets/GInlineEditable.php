...
class GInlineEditable extends GTag {
    ...
    public function init() {
        ...
        if (GInlineEditable::$_firstRun) {
            ...
            if (YII_DEBUG)
                $this->js[] = array('url' => $jeditable . '/jquery.jeditable.js');
            else
                $this->js[] = array('url' => $jeditable . '/jquery.jeditable.min.js');
        ...
        if ($this->type == 'editor') {
            if (GInlineEditable::$_firstEditor) {
                ...
                if (YII_DEBUG) {
                    $this->js[] = array('url' => $wysihtml5 . '/dist/wysihtml5-0.3.0.js');
                    $this->js[] = array('url' => $bootstrapwysihtml5 . '/dist/bootstrap3-wysihtml5.all.min.js');
                    $this->css[] = array('url' => $bootstrapwysihtml5 . '/dist/bootstrap3-wysihtml5.css');
                } else {
                    $this->js[] = array('url' => $wysihtml5 . '/dist/wysihtml5-0.3.0.min.js');
                    $this->js[] = array('url' => $bootstrapwysihtml5 . '/dist/bootstrap3-wysihtml5.all.min.js');
                    $this->css[] = array('url' => $bootstrapwysihtml5 . '/dist/bootstrap3-wysihtml5.min.css');
                }
                $this->js[] = array('url' => $wysihtml5 . '/parser_rules/advanced.js');
                $this->js[] = array('url' => G::assets() . '/js/jquery.editable.editor.js', CClientScript::POS_HEAD);
            }
