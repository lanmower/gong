...
class GSubmissionButtonColumn extends CButtonColumn {
    ...
    public $updateButtonUrl = 'Yii::app()->controller->createUrl("update",array("id"=>Yii::app()->controller->getVar("form")->hash, "dataId"=>CHtml::value($data, "hash")))';
    public $deleteButtonUrl = 'Yii::app()->controller->createUrl("delete",array("id"=>Yii::app()->controller->getVar("form")->hash, "dataId"=>CHtml::value($data, "hash")))';
    public $deleteButtonOptions = array('class'=>'delete prompt', 'title'=>'Delete');
    public $template='{update}{delete}';
    public $buttons = array('viewParent'=>array(
