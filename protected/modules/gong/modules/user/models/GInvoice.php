...
class GInvoice extends GActiveRecord {
    ...
    public function getGridColumns() {
        return array(
            array('name'=>'user.profile.company'),
            array('name'=>'user.profile.email'),
            /*array('name' => 'view'),*/
            array('value' => '$data->sizeHr'),
            array('name'=>'Total'),
            array('value' => '$data->sentHtml', 'type'=>'raw', 'name'=>'Send'),
            array('value' => '$data->paidHtml', 'type'=>'raw', 'name'=>'Paid'),
    ...
    public function rules() {
        return array(
            array('id, size, userId, paid, sent', 'numerical', 'integerOnly' => true),
        );
    }
