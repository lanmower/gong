...
(1,	407028930,	1,	'0000-00-00 00:00:00',	'2014-08-06 16:11:06'),
...
DROP TABLE IF EXISTS `video_custom_url`;
CREATE TABLE `video_custom_url` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(131,	'data',	'small.mp4',	'',	'2014-08-05 09:13:09',	NULL,	NULL,	'P',	'P',	'P',	1),
(132,	'data',	'small.mp4',	'',	'2014-08-05 09:15:08',	NULL,	NULL,	'P',	'P',	'P',	1),
(122,	'audio',	'09. Eyes Of Fya Dub.mp3',	'',	'2014-07-28 17:19:16',	NULL,	NULL,	'P',	'P',	'P',	36),
(130,	'data',	'small.mp4',	'',	'2014-08-05 09:12:09',	NULL,	NULL,	'P',	'P',	'P',	1),
(92,	'audio',	'09. Illegal Substances - Tradition (Chapter II).mp3',	'',	'2014-06-30 17:32:36',	NULL,	NULL,	'P',	'P',	'P',	36),
(137,	'data',	'small.mp4',	'',	'2014-08-05 09:24:25',	NULL,	NULL,	'P',	'P',	'P',	1),
(138,	'data',	'small.mp4',	'',	'2014-08-05 09:25:05',	NULL,	NULL,	'P',	'P',	'P',	1),
(139,	'data',	'small.mp4',	'',	'2014-08-05 09:27:28',	NULL,	NULL,	'P',	'P',	'P',	1),
(178,	'video',	'TF2-In-10-Seconds-SFM---YouTube.mp4',	'',	'2014-08-06 10:01:43',	NULL,	NULL,	'P',	'P',	'P',	1),
(179,	'video',	'VID_20140806_100811.3gp',	'',	'2014-08-06 10:08:08',	NULL,	NULL,	'P',	'P',	'P',	1),
(180,	'video',	'VID_20140806_100952.3gp',	'',	'2014-08-06 10:09:55',	NULL,	NULL,	'P',	'P',	'P',	1),
(181,	'video',	'VID_20140806_160804.3gp',	'',	'2014-08-06 16:08:35',	NULL,	NULL,	'P',	'P',	'P',	1);

DROP TABLE IF EXISTS `video_file_audio`;
CREATE TABLE `video_file_audio` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(27,	'Eyes Of Fya Dub',	'Midnite',	'Intense Pressure',	'2003',	'vtwin88cube',	'9',	'Reggae',	122);

DROP TABLE IF EXISTS `video_file_image`;
CREATE TABLE `video_file_image` (
...
DROP TABLE IF EXISTS `video_file_video`;
CREATE TABLE `video_file_video` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `fileId` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
DROP TABLE IF EXISTS `video_form`;
...
DROP TABLE IF EXISTS `video_friendship`;
CREATE TABLE `video_friendship` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `video_invoice`;
CREATE TABLE `video_invoice` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `size` bigint(40) NOT NULL,
...
DROP TABLE IF EXISTS `video_membership`;
CREATE TABLE `video_membership` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `video_payment`;
CREATE TABLE `video_payment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
  `text` text,
  PRIMARY KEY (`id`)
...
(179,	'',	NULL,	NULL,	'*',	'P',	'P',	'2014-08-05 08:38:04',	'2014-08-06 10:01:58',	NULL,	1),
(180,	'',	NULL,	NULL,	'P',	'P',	'P',	'2014-08-06 10:07:45',	NULL,	NULL,	1);

DROP TABLE IF EXISTS `video_post_file`;
...
(1077,	'video',	180,	179,	NULL),
(1078,	'video',	180,	180,	NULL),
(1079,	'video',	180,	181,	NULL);

DROP TABLE IF EXISTS `video_privacysetting`;
CREATE TABLE `video_privacysetting` (
  `userId` int(10) unsigned NOT NULL,
...
DROP TABLE IF EXISTS `video_profile_comment`;
CREATE TABLE `video_profile_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userId` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `video_profile_field`;
CREATE TABLE `video_profile_field` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `video_profile_visit`;
CREATE TABLE `video_profile_visit` (
...
DROP TABLE IF EXISTS `video_site_page`;
CREATE TABLE `video_site_page` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `video_site_page_element`;
CREATE TABLE `video_site_page_element` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `video_site_template`;
CREATE TABLE `video_site_template` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `view` varchar(255) DEFAULT '*',
  `edit` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `video_site_template_element`;
CREATE TABLE `video_site_template_element` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `mode` int(11) DEFAULT '1',
  `className` varchar(255) DEFAULT NULL,
  `name` varchar(255) DEFAULT NULL,
...
(4,	1,	'GImage',	'logoImage',	'',	'',	'{\"alt\":\"Coastal Accounting video exchange Logo\",\"htmlOptions\":{\"class\":\"logo\"},\"src\":\"\\/themes\\/video\\/images\\/Coastal Accounting video exchange_logo.png\"}',	NULL,	NULL,	'*',	'SUPER',	'',	'2013-08-12 00:00:00',	'2014-06-29 15:49:35',	1,	2,	1),
...
(17,	1,	'GTabs',	'tabs',	'',	'',	'{\"items\":[{\"linkOptions\":{\"class\":\"searchTab\"},\"icon\":\"glyphicon glyphicon-play glyphicon-2x\",\"url\":\"/index.php\",\"view\":\"*\"},{\"linkOptions\":{\"class\":\"uploadTab\"},\"icon\":\"glyphicon glyphicon-upload glyphicon-2x\",\"url\":\"/page/upload\",\"view\":\"Producer\"},{\"icon\":\"glyphicon glyphicon-envelope glyphicon-2x\",\"view\":\"g\",\"url\":\"/site/contact\"},{\"type\":\"login\",\"icon\":\"glyphicon glyphicon-off glyphicon-2x\"}],\"tabsOptions\":{\"placement\":\"left\"}}',	NULL,	NULL,	'*',	'SUPER',	'',	'2013-02-17 00:00:00',	'2014-08-05 08:37:00',	6,	2,	1),
...
DROP TABLE IF EXISTS `video_site_view`;
CREATE TABLE `video_site_view` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `video_site_view_element`;
CREATE TABLE `video_site_view_element` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `mode` int(11) DEFAULT '1',
  `className` varchar(255) DEFAULT NULL,
  `name` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `video_site_view_map`;
CREATE TABLE `video_site_view_map` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `video_textsettings`;
CREATE TABLE `video_textsettings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `video_userTest`;
CREATE TABLE `video_userTest` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `created` date NOT NULL,
  `modified` date NOT NULL,
...
DROP TABLE IF EXISTS `video_user_group`;
...
DROP TABLE IF EXISTS `video_user_group_message`;
CREATE TABLE `video_user_group_message` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `video_user_role`;
CREATE TABLE `video_user_role` (
  `userId` int(10) unsigned NOT NULL,
...
DROP TABLE IF EXISTS `video_visit`;
CREATE TABLE `video_visit` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
...
('q41jqv227etkpf9s8srkufec04',	1407337866,	'ddb03249a355d43c517b04bb620df9b6__id|s:1:\"1\";ddb03249a355d43c517b04bb620df9b6__name|s:5:\"admin\";ddb03249a355d43c517b04bb620df9b6id|s:1:\"1\";ddb03249a355d43c517b04bb620df9b6__states|a:1:{s:2:\"id\";b:1;}refresh|b:1;');
