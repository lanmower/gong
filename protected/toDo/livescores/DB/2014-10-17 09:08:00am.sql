...
--
-- Host: localhost
-- Generation Time: Oct 17, 2014 at 08:03 AM
...
(36, 36, '2014-10-12 14:02:44', 'protected', 'Vos', 'Producer', 1, 1, 'alistairnel@gmail.com', 'Production Company', '0723557267', 'P.O. Box 1008', 'Middelburg', 'Mpumalanga', 1100, 'US'),
...
(144, 1, 'GActiveDropDown', 'player', '', '', '{"displayFieldName":"name","listOptions":{"onchange":"$(this.form).trigger(\\"submit\\")"},"tableName":"scores_player"}', NULL, NULL, '@', 'SUPER', NULL, '2014-10-08 22:07:09', '2014-10-16 11:50:25', 2, 12, 1),
(145, 1, 'GScoreRankingTeam', 'ranking', '', '', NULL, NULL, NULL, '*', 'SUPER', NULL, '2014-10-12 20:33:11', NULL, NULL, 15, 1),
(146, 1, 'GScoreRankingFlighting', 'flightings', '', '', '[]', NULL, NULL, '*', 'SUPER', NULL, '2014-10-13 12:00:08', '2014-10-13 12:02:06', NULL, 16, 1);
...
(3, 2, 'GHeader', 'header', '', '', '{"tag":"div"}', NULL, NULL, '*', 'disabled', '', '2013-02-17 00:00:00', '2014-10-17 07:30:13', 0, 2, 1),
(4, 1, 'GImage', 'logoImage', '', '', '{"alt":"Coastal Accounting video exchange Logo","htmlOptions":{"class":"logo"},"src":"\\/themes\\/video\\/images\\/coastal-logo.png"}', NULL, NULL, 'disabled', 'disabled', '', '2013-08-12 00:00:00', '2014-10-17 07:30:13', 1, 2, 1),
(12, 3, 'GHeader', 'headerEnd', '', '', '[]', NULL, NULL, '*', 'disabled', 'null', '2013-06-27 00:00:00', '2014-10-17 07:30:13', 3, 2, 1),
(13, 1, 'GBusyPrompt', 'loading', '', '', '{"loadingImage":"\\/themes\\/video\\/images\\/ajax-loader.gif","loadingText":"","savingImage":"\\/themes\\/video\\/images\\/ajax-loader.gif","savingText":""}', NULL, NULL, '*', 'SUPER', '', '2013-07-10 00:00:00', '2014-10-17 07:30:13', 9, 2, 1),
(14, 1, 'GBrowserWarning', 'browserNotification', '', '', '[]', NULL, NULL, 'disabled', 'SUPER', '', '2013-07-10 00:00:00', '2014-10-17 07:30:13', 11, 2, 1),
(15, 1, 'GTag', 'loadingShadow', '', '', '{"htmlOptions":{"class":"fullscreen saving loading\\u00a0browserNotification"}}', NULL, NULL, '*', 'SUPER', '', '2013-07-10 00:00:00', '2014-10-17 07:30:13', 10, 2, 1),
(17, 1, 'GTabs', 'menu', '', '', '{"items":[{"linkOptions":{"class":"searchTab"},"icon":"glyphicon glyphicon-play glyphicon-2x","url":"\\/index.php"},{"linkOptions":{"class":"uploadTab"},"icon":"glyphicon glyphicon-upload glyphicon-2x","url":"\\/page\\/upload","view":"disabled"},{"linkOptions":{"class":"contactTab"},"icon":"glyphicon glyphicon-envelope glyphicon-2x","view":"disabled","url":"\\/site\\/contact"},{"linkOptions":{"class":"contactTab"},"icon":"glyphicon glyphicon-book glyphicon-2x","view":"admin","url":"\\/gong\\/site\\/page\\/list"},{"linkOptions":{"class":"contactTab"},"icon":"glyphicon glyphicon-th-large glyphicon-2x","view":"admin","url":"\\/gong\\/site\\/view\\/list"},{"icon":"glyphicon glyphicon-th glyphicon-2x","view":"admin","url":"\\/gong\\/site\\/template\\/list"},{"icon":"glyphicon glyphicon-th-list glyphicon-2x","view":"admin","url":"\\/gong\\/form\\/admin\\/list"},{"linkOptions":{"class":"loginTab"},"type":"login","icon":"glyphicon glyphicon-off glyphicon-2x"}],"tabsOptions":{"nplacement":"left"}}', NULL, NULL, '@', 'SUPER', '', '2013-02-17 00:00:00', '2014-10-17 07:30:13', 5, 2, 1),
(44, 1, 'GTag', 'footer', '', '', '{"htmlOptions":{"class":"Footer"}}', NULL, NULL, '*', 'SUPER', 'null', '2013-08-27 17:15:11', '2014-10-17 07:30:13', 8, 2, 1),
(91, 1, 'GPlayer', 'player', '', '', '[]', NULL, NULL, 'disabled', 'disabled', 'null', '2014-02-18 01:52:04', '2014-10-17 07:30:13', 2, 2, 1),
...
(152, 1, 'GArticle', 'content', '', '', '{"htmlOptions":{"class":"tab-content"}}', NULL, NULL, '*', 'SUPER', '', '2014-04-28 22:55:30', '2014-10-17 07:30:13', 6, 2, 1),
(153, 1, 'GFileUploader', 'uploader', '', '', '[]', NULL, NULL, 'disabled', 'SUPER', NULL, '2014-06-29 15:49:20', '2014-10-17 07:30:13', 12, 2, 1),
(154, 2, 'GTag', 'adminBackground', '', '', '[]', NULL, NULL, '@', 'SUPER', NULL, '2014-10-17 07:29:17', '2014-10-17 07:30:22', 4, 2, 1),
(155, 3, 'GTag', 'adminBackground', '', '', '[]', NULL, NULL, '@', 'SUPER', NULL, '2014-10-17 07:29:58', '2014-10-17 07:30:31', 7, 2, 1),
(156, 1, 'GImage', 'headerFlags', '', '', '{"htmlOptions":{"class":"logo"},"src":"/themes/livescores/images/headerFlags.png"}', NULL, NULL, '*', 'SUPER', NULL, '2014-10-17 07:52:27', '2014-10-17 07:54:50', NULL, 2, 1);
...
(2, 'de', 'Sie haben sich fÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¼r unsere Applikation registriert. Bitte bestÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¤tigen Sie ihre E-Mail adresse mit diesem Link: {activation_url}', 'Sie haben sich fÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¼r eine Applikation registriert.', 'Sie haben ein neues Passwort angefordert. Bitte klicken Sie diesen link: {activation_url}', 'Ihr Konto wurde freigeschaltet.', 'Der Benutzer {username} hat Ihnen eine Freundschaftsanfrage gesendet. \n\n							 Nachricht: {message}\n\n							 Klicken sie <a href="{link_friends}">hier</a>, um diese Anfrage zu bestÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¤tigen \r\noder zu ignorieren. Alternativ kÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¶nnen sie <a href="{link_profile}">hier</a> auf ihre Profilseite zugreifen.', 'Der Benutzer {username} hat ihre Freundschaftsanfrage \nbestÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¤tigt.', '\n							 Benutzer {username} hat Ihnen eine Nachricht auf Ihrer Pinnwand hinterlassen: \n\n							 {message}\n\n							 <a href="{link}">hier</a> \r\ngeht es direkt zu Ihrer Pinnwand!', 'Sie haben eine neue Nachricht von {username} bekommen: {\r\nmessage}', 'Ihre Bestellung der Mitgliedschaft {membership} wurde am {order_date} entgegen genommen. Die gewÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¤hlte Zahlungsart ist {payment}. Die Auftragsnummer lautet {id}.', 'Ihre Zahlung wurde am {payment_date} \r\nentgegen genommen. Ihre Mitgliedschaft mit der Nummer {id} ist nun Aktiv.'),
(3, 'es', 'Te has registrado en esta aplicaciÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n. Para confirmar tu direcciÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n de correo electrÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³nico, por favor, visita {activation_url}.', 'Te has registrado en esta aplicaciÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n.', 'Has solicitado una nueva contraseÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ±a. Para establecer una nueva contraseÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ±a, por \r\nfavor ve a {activation_url}', 'Tu cuenta ha sido activada. Gracias por registrarte.', 'Has recibido una nueva solicitud de amistad de {user_from}: {message} Ve a tus contactos: {link}', 'Tienes un nuevo comentario en tu perfil de {username}: {message} visita tu perfil: {link}', 'Please translatore thisse hiere toh tha espagnola langsch {username}', 'Has recibido un mensaje de {\nusername}: {message}', 'Tu orden de membresÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­a {membership} de fecha {order_date} fuÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ© tomada. Tu nÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂºmero de \r\norden es {id}. Escogiste como modo de pago {payment}.', 'Tu pago \r\nfuÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ© recibido en fecha {payment_date}. Ahora tu MembresÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­a {id} ya estÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡ activa'),
(4, 'fr', '', '', '', '', '', '', '', '', '', ''),
(5, 'ro', '', '', '', '', '', '', '', '', '', '');
...
INSERT INTO `scores_group` (`id`, `name`, `css`, `tournamentId`, `created`, `modified`) VALUES
(3, 'Group 1', 'scores_group1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(4, 'Group 2', 'scores_group2', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(5, 'Group 3', 'scores_group3', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(6, 'Group 4', 'scores_group4', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
('qfbjjfsf713p2ldlaj2qk9s4s6', 1413529220, 0x726566726573687c623a313b);
