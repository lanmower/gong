...
class GProfileController extends GController {
    ...
    public function accessRules() {
        return array(
            ...
            array('allow',
                'actions' => array('view', 'update', 'edit', 'ajaxUpdate', 'index'),
                'users' => array('@'),
            ),
    ...
    public function actionUpdate($id = null) {
        ...
        $this->render('update', array('model'=>$profile));
    }
    ...
    public function updateVisitor($visitor_id, $visited_id) {
        ...
        $visit = GProfileVisit::model()->find(
    ...
    public function actionAjaxUpdate() {
        try {
            ...
            if (!$profile->save(true, array($_POST['name'])))
