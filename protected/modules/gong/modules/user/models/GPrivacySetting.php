...
class GPrivacysetting extends GActiveRecord {
	...
	public function rules() {
		return array (
				array (
						'userId, message_new_friendship, message_new_message, message_new_profilecomment',
						'required' 
				),
				array (
						'appear_in_search, message_new_friendship, message_new_message, message_new_profilecomment, public_profile_fields, show_online_status, log_profile_visits',
						'numerical',
						'integerOnly' => true 
				),
				array (
