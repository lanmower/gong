...
--
-- Host: localhost
-- Generation Time: Mar 18, 2014 at 09:02 PM
...
--
-- Table structure for table `m2m_form_field`
--

CREATE TABLE IF NOT EXISTS `m2m_form_field` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `m2m_form_field`
--
...
(5, 'GPasswordField', 'verifyPassword', 'Retype password', '', '', '', '[]', '', '', '*', '2013-11-20', '2014-03-17', 0, 2, 0),
...
--
-- Table structure for table `m2m_form_list_field`
--

CREATE TABLE IF NOT EXISTS `m2m_form_list_field` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `className` varchar(255) COLLATE utf8_swedish_ci NOT NULL,
  `name` varchar(255) COLLATE utf8_swedish_ci DEFAULT NULL,
  `title` text COLLATE utf8_swedish_ci,
...
--
-- Table structure for table `m2m_form_page`
--

CREATE TABLE IF NOT EXISTS `m2m_form_page` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_swedish_ci NOT NULL,
...
--
-- Dumping data for table `m2m_form_page`
--
...
--
-- Table structure for table `m2m_id3`
--

CREATE TABLE IF NOT EXISTS `m2m_id3` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
(15, 11, 39, 1, 1395064889, 1426600889, NULL, NULL, NULL, NULL, NULL, 0),
(16, 11, 40, 1, 1395069356, 1426605356, NULL, NULL, NULL, NULL, NULL, 0),
(17, 11, 41, 1, 1395072122, 1426608122, NULL, NULL, NULL, NULL, NULL, 0),
(18, 11, 42, 1, 1395072597, 1426608597, NULL, NULL, NULL, NULL, NULL, 0),
(19, 11, 43, 1, 1395072641, 1426608641, NULL, NULL, NULL, NULL, NULL, 0);
...
--
-- Table structure for table `m2m_page`
--

CREATE TABLE IF NOT EXISTS `m2m_page` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `m2m_page`
--
...
--
-- Table structure for table `m2m_page_element`
--

CREATE TABLE IF NOT EXISTS `m2m_page_element` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `m2m_page_element`
--
...
--
-- Table structure for table `m2m_page_element_file`
--

CREATE TABLE IF NOT EXISTS `m2m_page_element_file` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `view` varchar(255) DEFAULT '*',
  `edit` varchar(255) DEFAULT NULL,
  `delete` varchar(255) DEFAULT NULL,
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf16 COLLATE=utf16_swedish_ci AUTO_INCREMENT=152 ;
...
(150, 'asdf', NULL, NULL, 'F', 'P', '*', '2014-03-17 16:19:01', '2014-03-17 16:43:00', NULL, 36),
(151, '', NULL, NULL, 'P', 'P', '*', '2014-03-17 16:34:53', '2014-03-17 16:45:59', NULL, 36);
...
(764, 'image', 'Folder.jpg', '2014-03-17 16:46:47', NULL, NULL, 151);

-- --------------------------------------------------------

--
-- Table structure for table `m2m_post_file_id3`
--

CREATE TABLE IF NOT EXISTS `m2m_post_file_id3` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_swedish_ci AUTO_INCREMENT=363 ;

--
-- Dumping data for table `m2m_post_file_id3`
--
...
--
-- Table structure for table `m2m_post_file_image`
--

CREATE TABLE IF NOT EXISTS `m2m_post_file_image` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `fileId` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=646 ;

--
-- Dumping data for table `m2m_post_file_image`
--
...
(1, 1, '2014-03-18 19:01:31', 'protected', 'admin', 'admin', 1, 1, 'alistairnel@gmail.com', 'Almagest Fraternite', '1111111111111', 'Ghost Street', 'Durban', 'KZNasdf', 4000, 'zzr'),
(2, 2, '2013-02-18 00:06:30', 'protected', 'Nel', 'Alistair', 1, 1, 'alistair@blahblahblah.co.za', 'test', '27393192111', 'test', 'test', 'KZN', 4000, 'ZA'),
(35, 35, '2014-03-03 10:04:32', 'protected', 'James', 'Reporter', 1, 1, 'a@a.c', 'Almagest Fraternite', '0723557267', 'P.O. Box 1008', 'Belfast', 'Kwazulu Natal', 1100, 'ZA'),
(36, 36, '2014-03-07 13:09:19', 'protected', 'Vos', 'Producer', 1, 1, 'r@r.c', 'Production Company', '0723557267', 'P.O. Box 1008', 'Middelburg', 'Mpumalanga', 1100, 'US'),
...
(40, 39, '0000-00-00 00:00:00', 'protected', '', '', 1, 1, 'test@test.c', '', '', '', '', '', 0, ''),
(41, 40, '0000-00-00 00:00:00', 'protected', '', '', 1, 1, 'test@t.c', '', '', '', '', '', 0, ''),
(42, 41, '0000-00-00 00:00:00', 'protected', '', '', 1, 1, 'b@gmail.com', '', '', '', '', '', 0, ''),
(43, 42, '0000-00-00 00:00:00', 'protected', '', '', 1, 1, 'mail@f.com', '', '', '', '', '', 0, ''),
(44, 43, '0000-00-00 00:00:00', 'protected', '', '', 1, 1, 'f@f.c', '', '', '', '', '', 0, '');
...
--
-- Table structure for table `m2m_template`
--

CREATE TABLE IF NOT EXISTS `m2m_template` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `view` varchar(255) DEFAULT '*',
  `edit` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `m2m_template`
--
...
--
-- Table structure for table `m2m_template_element`
--

CREATE TABLE IF NOT EXISTS `m2m_template_element` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `mode` int(11) DEFAULT NULL,
  `className` varchar(255) DEFAULT NULL,
  `name` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `m2m_template_element`
--
...
(1, 'admin', '2a8c58fdb3d603b8e21d7d6cfc24b4d7b8c58e6d9cc6b755f91722fa724f37ae2fe94b682de5801e154fed28b140bca8a7fbfa6719aecc462786adbba1b11bfa', '1cKpqyPTh3pnytonuQzaxIomnzuLwDVN/rhfCtF78pmyPlB7oSwV2SVvI0pjsuXdsIkrUM+4xcwi4oM8BZG+wg==', '7d92e73617ad567fd16556dd9f3bd9c885b2dcd28a7cadd3a79cfaf61633dd2072b4d99a7ed3d6e21ecd37bacbbc363ec77ede758bfc5361dd2ba0d21c87ec3a', 1335171345, 1395169344, 0, 0, 1, 1, 0, 1, '', 'Instant'),
(2, 'peter', '9f545c61ccb9610fb3fa59fbd366a86427e176719ccd4686fb7ea62c953eca5292a60b5a88794fd147abdec0608850fd322a57e686dc2986ada4e87e7fa04fc0', 'iVz0Sl+EWFq+KjhL6cHIS+pYMIcZtBdiaFgqTvOFzfkGymGpod65wQCQNJzWsL5jOQ2C1SVCHWpdHYf9wn8H+g==', '061a310c41013ec047e9bacb167e600923a6cce4c0bd65f34b87b45c8638c53b88d42096700781ea9b51cbe5fc455ad75dc29aa2d6ebcb16f0810bd2411fd412', 1394197762, 1395169179, 0, 1394197762, 0, 1, 1, 1, NULL, 'Instant'),
...
(39, 'almagest', 'd6595f92e305915e648f0fb39e8e4bc11434e086b648a45d6173600a3111bfb256b9a5b72360c6fea09f4702bb649ecce6d0f7ac1cb5867a04de1f24bd91cd21', 'lQpYFBNruZZzmZCpmQlqktIv6+lpjgBc1n04IMVP2OlKfK8HdcgZjvlw93HpDJX61WetHKJuOVEjk6QG85btNA==', '5bbf38add5ceef60a3988a158e9c7c37b90e217e2056ed78dea3f05c99ebb2bd89e3b04547b4e8fbf16e928cb32d284ea6a2e38e5c2f2f90c572024d6de5ba70', 1395064887, 0, 0, 1395064887, 0, 0, 0, 0, NULL, 'Instant'),
(40, 'aceme', '2d6aab2dc89717dc1fe7db8cb3fa9ac44f1f50f2eb7905a2398ab0ad2b1202c54c0c16d372cf025868dbe3df69bec486ff7eaf8c987e4fcafe58075171f810c1', 'NpmLMXD2cADBum77hywn2Qr79Ik1Z8Hwzudj3aeuZvm8IYumzgjXkWfA2jreQITx/Q2RyAvA4d7ikmHLZ2LLUw==', 'd72225a9cbf25f5822e4336f8633528e129b28a2733b50eb9d3e55482e2413b5f631b3fc25a1d4da1a260044132bc41b60bf1263e2af66aab2f0b95cb0c56a00', 1395069352, 0, 0, 1395069352, 0, 0, 0, 0, NULL, 'Instant'),
(41, 'lanmower', 'e2adecafc4b71a0ada969472ea7e8e53e168b778524ca26893122601c71a4fcea1d9d067794ec75da5c7d025712680fb2ee6d9f9bb4b8c9353a66f205af41272', '64xHF9zE4qBMmuoxSBgmHJBStt9bX92LL5NUYr8Egkyk4LJXeTUWr/TT73g00OqQlB3v6gEp0o2pZKebsF5Vrg==', 'b560282f0ac6d773d8bec7bfc357c2efb4801deda8458e7e3f100f8a7631d5bd6110b3e507638277d799fa8007b9b5341039dd6463aed58122d2ef68980b1482', 1395072114, 0, 0, 1395072114, 0, 0, 0, 0, NULL, 'Instant'),
(42, 'asdf', 'd479bfb2b0fc9048f3b2ecb158d8455547070317a218a0de76d6774a1195c1660392c6f8e913eee6fe24be39de0e54119bd24705f36b14d67064de4fe88b4e52', 'rBLwQU0hpuq+FzgcB00CDM/FXkoZhO16+AHS7TsxG//efsdOiU0LNmCMlOfA+ZEDN6QPgRD/hQokh5qBH36JeQ==', '541a0ab48eaa455bde4d858d512fe68d942a5299a29a50eafd9581d4897ce7b5c95b9743e137c175794b88e3d40445e4deba4a3340c211831b5472dc591678c7', 1395072593, 0, 0, 1395072593, 0, 0, 0, 0, NULL, 'Instant'),
(43, 'crappypatty', '56dc6b2abb7cdaafc91ac8695892549453dcbd48b3f292f8adb100e6d1876d80a2f3129be9c764a74033e09c4d596dfec29c2109546109cb24c82c2abfc42656', 'sTSJ2jDS0pZb7jqNZRL5M4Jz/seUIbi3hlTsX19F/vD4TSQDdibxnT7DITAhJwpyZpj+3cvtRnlvhNNY1bQhrA==', 'dd08f460fcc001d4f11c3aa22369a7c138a8325e6b66c16e27d64b8c86a20b3e6e133728c997e039527de9567d1c8635995935a47e5762aafbb0b80f3b26de3d', 1395072635, 0, 0, 1395072635, 0, 0, 0, 0, NULL, 'Instant');
...
CREATE TABLE IF NOT EXISTS `m2m_userTest` (
  ...
  `verifyPassword` varchar(255) CHARACTER SET utf8 COLLATE utf8_swedish_ci NOT NULL,
...
('0tfh1g3f6jtq077k9jt4ra2f24', 1395201748, 0x726566726573687c623a313b);
