...
class GTerms extends GField {
    ...
    public function getRules() {
        $terms_rule = array('compare'=>array('compare' ,'compareValue'=>true, 'message'=>'You must agree to the terms and conditions'));
    ...
    public function run() {
        ...
        echo CHtml::link(" (Click here to read) ", "javascript:;", array("class"=>"dialog", 'data-target'=>'.'.$this->id));
