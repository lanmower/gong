...
class GProfileVisit extends GActiveRecord {
	...
	public function relations() {
		return array(
				'visitor' => array(self::BELONGS_TO, 'GUser', 'visitor_id'),
				'visited' => array(self::BELONGS_TO, 'GUser', 'visited_id'),
				);
	}

	public function attributeLabels() {
		return array(
				'visitor_id' => G::t('Visitor'),
				'visited_id' => G::t('Visited'),
				'timestamp_first_visit' => G::t('Time of first visit'),
				'timestamp_last_visit' => G::t('Time of last visit'),
				'num_of_visits' => G::t('Total Num of Visits'),
				);
	}
