...
class GProfileCommentController extends GController {
	...
	public function actionDelete($id) {
		...
		if ($comment->userId == Yii::app ()->user->id || $comment->profile_id == Yii::app ()->user->id) {
			$comment->delete ();
			$this->redirect ( array (
					G::module ()->profileView,
					'id' => $comment->profile->userId 
			) );
		} else
			throw new CHttpException ( 400, G::t ( 'You are not the owner of this Comment or this Profile!' ) );
	}
