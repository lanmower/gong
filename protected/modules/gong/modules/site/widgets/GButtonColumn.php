...
class GButtonColumn extends CButtonColumn {
    ...
    public $updateButtonUrl = 'Yii::app()->controller->createUrl("update",array("id"=>CHtml::value($data, "hash")))';
    public $deleteButtonUrl = 'Yii::app()->controller->createUrl("delete",array("id"=>CHtml::value($data, "hash")))';
    public $deleteButtonOptions = array('class'=>'delete prompt', 'title'=>'Delete');
    public $template='{self}{delete}';
