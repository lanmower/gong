...
$this->breadcrumbs = array(Gong::t('User Verification')); ?>
<h2> <?php echo Gong::t('User Verification'); ?> </h2>


<div class="form inline-form">
    <?php
    $activeform = $this->beginWidget('CActiveForm', array(
        'id' => 'User Verification-form',
...
<?php echo CHtml::submitButton(Gong::t('Verify')); ?>
    </div>
