...
class GFriendship extends GActiveRecord {
    ...
    public function rules() {
        return array(
            array('inviterId, friendId, status, created, modified, message', 'safe'),
            array('inviterId', 'unique', 'criteria' => array(
    ...
    public function relations() {
        return array(
            'inviter' => array(self::BELONGS_TO, 'GUser', 'inviterId'),
            'friend' => array(self::BELONGS_TO, 'GUser', 'friendId'),
        );
    }
