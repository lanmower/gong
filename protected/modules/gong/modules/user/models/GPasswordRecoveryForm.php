	...
	public function checkexists($attribute, $params) {
		...
		if (! $this->hasErrors ()) {
			if (strpos ( $this->login_or_email, "@" )) {
				...
				if (! $this->user instanceof GUser)
					$this->addError ( $attribute, "this email is not registered on this site." );
				...
				if (! $this->user instanceof GUser)
					$this->addError ( $attribute, "this user name is not registered on this site." );
				return $this->user instanceof GUser;
			}
		}
		return false;
