...
<ul class="jp-controls">
    ...
    <li><a href="javascript:;" class="jp-pause" tabindex="1"><i class="glyphicon glyphicon-pause glyphicon-2x"></i></a></li>
    <li><a href="javascript:;" class="jp-next" tabindex="1"><i class="glyphicon glyphicon-forward glyphicon-2x"></i></a></li>
    <li><a href="javascript:;" class="jp-stop" tabindex="1"><i class="glyphicon glyphicon-stop glyphicon-2x"></i></a></li>
</ul>
<br/>
...
<?php
echo CHtml::tag('span', array('id' => $playerId, 'class' => 'jp-jplayer'));
?>