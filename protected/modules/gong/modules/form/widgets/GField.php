...
class GField extends GTag {
    ...
    public function beforeInit() {
        if(!isset($this->submission)) $this->submission = $this->controller->getVar('model');
        if(!isset($this->name) && isset($this->model) && isset($this->model->name)) $this->name = $this->model->name;
        if(!isset($this->label) && isset($this->name)) $this->label = ucfirst (G::splitCamelCase ($this->name));
    ...
    public function getRules() {
        ...
        $rules = array_merge($rules, array('safe'));
        return $rules;
    }
    ...
    public function getGridColumns() {
        return array(array('name'=>$this->name, 'class'=>'GFieldEditableColumn'));
    }
