<?php
Yii::app()->clientScript->registerScript("formScript-$form->id",
...
echo $formWidget->errorSummary($model,"","", $htmlOptions=array('class'=>'errorSummary alert alert-danger'));
...
echo CHtml::button('Save', array('type' => 'submit', 'class' => 'btn btn-large btn-primary'));
