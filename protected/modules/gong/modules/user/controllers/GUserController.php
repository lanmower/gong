...
class GUserController extends GModelController {
    ...
    public function accessRules() {
        return array(
            ...
            array('allow',
                'actions' => array('profile', 'logout', 'changepassword', 'passwordexpired', 'delete', 'browse', 'publish'),
                'users' => array('@'),
            ),
            array('allow',
                'actions' => array('list', 'fieldUpdate'),
                'expression' => array('GUserController', 'canUpdate'),
            ),
    ...
    public function actionCreateTable() {
        ...
        $this->render("createTable", array('model' => $model));
    }
    ...
    public function actionFieldUpdate($attribute, $value, $id = null) {
        ...
        $this->render('fieldUpdateDone', array('model' => $model));
    }
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['GUser'])) {
            ...
            if (isset($_POST['GUserChangePassword'])
                    && $_POST['GUserChangePassword']['password'] != '') {
    ...
    public function actionList($name = null, $id = null) {
        ...
        $dataProvider = new CActiveDataProvider('GUser', array('criteria'=>$criteria, 'sort'=>array(
    ...
    public function actionDelete($id = null) {
        ...
        if (Yii::app()->user->isAdmin()) {
            ...
            if ($user && ($user->id == Yii::app()->user->id)) {
                ...
                $this->redirect(array('//gong/user/user/list'));
            }
