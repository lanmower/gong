...
class GModelController extends GController {
    ...
    public function getModelClassname() {
        if(isset($this->_modelClassname)) return $this->_modelClassname;
    ...
    public function accessRules() {
        return array(
            array('allow',
                'actions' => array('create', 'update', 'delete', 'list', 'inlineUpdate',  'view', 'reorder'),
                'expression' => array(get_class($this), 'canUpdate'),
            ),
            array('deny',
                'users' => array('*'),
            ),
